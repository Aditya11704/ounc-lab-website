...
const SignIn: React.FC = () => {
  ...
  return (
    <main className="flex-grow flex flex-col items-center justify-center bg-black min-h-[85vh] py-20 px-4">
      ...
      <div className="bg-white rounded-[2rem] p-8 md:p-12 w-full max-w-[480px] shadow-2xl relative">
        ...
        <div className="relative flex items-center justify-center my-8">
          ...
          <span className="relative bg-white px-4 text-sm font-bold text-black">or</span>
        </div>

        <div className="flex justify-center gap-4 pb-4">
          <button onClick={() => handleSocialLogin('Google')} className="size-12 rounded-full bg-[#E0E0E0] hover:bg-[#D0D0D0] transition-colors flex items-center justify-center" aria-label="Sign in with Google">
          ...
          <button onClick={() => handleSocialLogin('Facebook')} className="size-12 rounded-full bg-[#E0E0E0] hover:bg-[#D0D0D0] transition-colors flex items-center justify-center" aria-label="Sign in with Facebook">
          ...
          <button onClick={() => handleSocialLogin('GitHub')} className="size-12 rounded-full bg-[#E0E0E0] hover:bg-[#D0D0D0] transition-colors flex items-center justify-center text-black" aria-label="Sign in with GitHub">
          ...
          <button onClick={() => handleSocialLogin('Apple')} className="size-12 rounded-full bg-[#E0E0E0] hover:bg-[#D0D0D0] transition-colors flex items-center justify-center text-black" aria-label="Sign in with Apple">
