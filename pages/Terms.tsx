...
const Terms: React.FC = () => {
  return (
    <main className="flex-grow bg-white text-black font-body pt-32 pb-24">
      <div className="max-w-[800px] mx-auto px-6 lg:px-12">
        <h1 className="text-3xl font-bold mb-2">terms of use</h1>
        <p className="text-gray-600 mb-10">Last updated: September 01, 2026</p>

        <div className="space-y-6 text-gray-800 leading-relaxed text-sm lg:text-base">
          <p>
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Ounc Private Limited, Visakhapatnam.</li>
            <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
            <li><strong>Service</strong> refers to the Website.</li>
            <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.</li>
            <li><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
            <li><strong>Website</strong> refers to our website, accessible from https://www.ounc.in</li>
          ...
          <p>
            ...
            If you have any questions about these Terms and Conditions, You can contact us via : mail@ounc.in
          </p>

          <div className="pt-12 pb-4 mt-12 border-t border-gray-200 flex justify-center print:hidden">
            <button 
              onClick={() => window.print()} 
              className="bg-black text-white px-8 py-3 rounded-full font-bold uppercase tracking-wider text-sm hover:bg-gray-800 transition-colors flex items-center gap-2"
            >
